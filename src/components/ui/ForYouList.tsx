...
const ForYouList = () => {
    ...
    <div>
      <div className="w-60 h-40 relative">
        ...
        <div className="group absolute top-0 left-0 w-full h-full flex justify-center items-center bg-background-movie-poster opacity-0 transition-opacity duration-500 ease-in-out hover:opacity-90">
          <button className="transform translate-y-full opacity-0 transition-all duration-500 ease-in-out group-hover:translate-y-0 group-hover:opacity-100 text-white text-4xl">
            <FaPlay />
          </button>
        </div>
      </div>
  ...
  return (
    <div className="py-5 pl-4 lg:pl-12">
      ...
      <div className="min-w-full w-[calc(100vw - 4.375rem)] flex flex-nowrap gap-3 overflow-x-scroll no-scrollbar">
